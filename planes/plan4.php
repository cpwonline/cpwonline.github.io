<div class="vist_plan">
	<div class="den"><h6>Sitio Web y Dominio:</h6> Gratis (Con extensi&oacute;n .ve)</div>
	<div class="den"><h6>Administración por SGAC:</h6> SUPER-ECONOMIC</div>
	...
	<div class="den"><h6>Cuentas de correo:</h6> 5</div>
	<div class="den"><h6>Almacenamiento:</h6> 1Gb</div>
	<div class="den"><h6>Diagn&oacute;stico de errores:</h6> No</div>
	<div class="den"><h6>Copias de seguridad/d&iacute;a:</h6> No</div>
	<div class="den"><h6>Panel de estad&iacute;sticas:</h6> No</div>
	<div class="den"><h6>Protecci&oacute;n fuerza bruta:</h6> No</div>
