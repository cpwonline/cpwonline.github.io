<div class="vist_plan">
	...
	<div class="den"><h6>Administración por SGAC:</h6> ULTIMATE</div>
	...
	<div class="den"><h6>Cuentas de correo:</h6> 100</div>
	<div class="den"><h6>Almacenamiento:</h6> Ilimitado</div>
	...
	<div class="den"><h6>Indexaci&oacute;n</h6> S&iacute;</div>
	<div class="den"><h6>Sistema DAL15:</h6> S&iacute;</div>
	<div class="den"><h6>Procesamiento y memoria:</h6> Doble</div>
	<div class="den"><h6>Servidor:</h6> Optimizado</div>
	<?php
		$plan = "Ultimate";
